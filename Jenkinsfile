            ...
            container('owaspppp') {
             ...
             script {
               ...
               def exitCode = sh script: """ zap-baseline-custom.py -r ${props.name_report} -g gen.conf -d -m 5 \ 
                                             -t ${props.website}  \ 
                                             --auth_auto  \
                                             --auth_loginurl ${props.auth_loginurl}  \
                                             --auth_username ${props.auth_username}  \
                                             --auth_password ${props.auth_password}  \
                                             --auth_usernamefield ${props.auth_username}  \
                                             --auth_passwordfield ${props.auth_password}  \
